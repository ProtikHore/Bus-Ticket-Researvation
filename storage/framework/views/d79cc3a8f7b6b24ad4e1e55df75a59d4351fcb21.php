...
<!---->
        <div class="grid-form1">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="deprature_time" placeholder="" name = "deprature_time" required="">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Available Seat</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="available_seat" placeholder="" name = "available_seat" required="">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="selected_seat" placeholder="" name = "selected_seat" required="">
            </div>
          </div>
          <div class="form-group">
            <!-- <label for="inputPassword3" class="col-sm-2 control-label hor-form">Price</label> -->
