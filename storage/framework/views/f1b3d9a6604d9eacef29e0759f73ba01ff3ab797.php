        ...
        <div class="grid-form1">
          ...
          <form method = "POST" class="form-horizontal">
            ...
            <div class="form-group">
  						...
  						<div class="col-sm-10">
                <select disabled="" id="bus_type" class="form-control1" name = "bus_type">
    							<option value = "<?php echo e($uid->bus_type); ?>"><?php echo e($uid->bus_type); ?></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="deprature_time" placeholder="" name = "deprature_time" value = "<?php echo e($uid->deprature_time); ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Available Seat</label>
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="available_seat" placeholder="" name = "available_seat" value = "<?php echo e($uid->available_seat); ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Price</label>
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="price" placeholder="" name = "price" value = "<?php echo e($uid->price); ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Selected Seat</label>
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="selected_seat" placeholder="" name = "selected_seat" value = "<?php echo e($uid->selected_seat); ?>">
            </div>
          </div>
          <div class="form-group">
            <!-- <label for="inputPassword3" class="col-sm-2 control-label hor-form">Price</label> -->
