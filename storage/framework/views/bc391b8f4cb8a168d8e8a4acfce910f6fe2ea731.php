	...
	<div class="sin-w3-agile">
      ...
      <?php echo e(csrf_field()); ?>
			...
			<div class="clearfix"></div>
				...
				<div class="back">
					<a href="<?php echo e(route('registration.index')); ?>">New User</a>
				</div>

				<?php if(session()->has('message')): ?>
          <div class="alert alert-danger"> <?php echo e(session('message')); ?> For The User <span style="color: #155724"><strong><?php echo e(session('username')); ?></strong></span></div>
        <?php endif; ?>
