...
<!---->
        <div class="grid-form1">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="deprature_time" placeholder="" name = "deprature_time" value = "{{$uid->deprature_time}}">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Available Seat</label>
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="available_seat" placeholder="" name = "available_seat" value = "{{$uid->available_seat}}">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Price</label>
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="price" placeholder="" name = "price" value = "{{$uid->price}}">
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Selected Seat</label>
            <div class="col-sm-10">
              <input disabled="" type="text" class="form-control" id="selected_seat" placeholder="" name = "selected_seat" value = "{{$uid->selected_seat}}">
            </div>
          </div>
          <div class="form-group">
            <!-- <label for="inputPassword3" class="col-sm-2 control-label hor-form">Price</label> -->
