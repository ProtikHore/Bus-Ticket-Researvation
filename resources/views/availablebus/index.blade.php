                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    @foreach ($bus as $availablebus)


                                    <tbody>
                                        <tr>
                                            <td>{{$availablebus->bus_type}}</td>
                                            <td>{{$availablebus->deprature_time}}</td>
                                            <td>{{$availablebus->available_seat}}</td>
                                            <td>{{$availablebus->price}}</td>
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('buyticket.index', $availablebus->id)}}">Buy Ticket</a>
                                                <!-- Modal -->
