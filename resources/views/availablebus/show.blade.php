            ...
            @foreach ($bus as $buses)
						<tbody>
						  <tr>
							...
							<td>{{$buses->deprature_time}}</td>
							<td>{{$buses->available_seat}}</td>
							<td>{{$buses->price}}</td>
							<td>{{$buses->selected_seat}}</td>
							<td><a href="{{route('availablebus.edit', $buses->id)}}">Update</a> | <a href="{{route('availablebus.delete', $buses->id)}}">Delete</a></td>
							<!-- <td>Female</td>
							<td>5'4</td>
